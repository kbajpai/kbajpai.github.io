...
\textbf{Dotnet Core}, \textbf{C\#}, \textbf{SSIS},Python, \textbf{BASH}, Cygwin, \textbf{Ubuntu}, \textbf{MVC 4.0/5.0}, \textbf{Azure}, AngularJS, \textbf{ColdFusion}, CFML, HTML5, \textbf{Bootstrap}, CSS, \textbf{AJAX}, \textbf{jQuery}, JavaScript, JSON, \textbf{WebAPI}, RESTful Services, LINQ, Web API, Entity Framework 6, SQL Server 2008/2012/2016, MSTest NUnit, \textbf{Git}, Jira, \textbf{Jenkins}, \textbf{TeamCity}, \textbf{Perforce}, Agile/Waterfall Development, \textbf{Docker}, \textbf{Kubernetes}
...
\section{Professional Experience}
    ...
    \noindent
    \begin{tabular}[t]{@{}l}
    \Large{MTM Business Solutions (Broadridge)}
    \end{tabular}
    \hfill
    \begin{tabular}[t]{l@{}}
    \textbf{Deer Park NY}
